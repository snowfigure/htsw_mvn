...
//                } catch (ParserException e) {}
    ...
    public static void main(String args[]) {
        ...
        String mailUser = "htsw_no_reply";          //发送邮件服务器的用户帐号
        String mailPassword = "HtswNoReply2015";  //发送邮件服务器的用户密码
        String[] toAddress = {"htsw_no_reply@163.com"};
        //使用超文本格式发送邮件
...
//            sendmail.setAttachments("E:\\TOOLS\\pm_sn.txt");
            sendmail.setMailFrom("htsw_no_reply@163.com");
