...
<head>
    ...
    <link rel="icon" type="image/png" href="/assets/amazeui_2.3.0/i/favicon.png">
    <link rel="apple-touch-icon-precomposed" href="/assets/amazeui_2.3.0/i/app-icon72x72@2x.png">
                    ...
                    <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav">
                        ...
                        <li>
                            <a href="admin-gallery.html">
                                <span class="am-icon-th"></span> 相册页面
