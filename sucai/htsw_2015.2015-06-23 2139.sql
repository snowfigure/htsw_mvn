...
CREATE TABLE `apply` (
  ...
  `cloud_file_url` varchar(128) default NULL COMMENT '通过百度云、360网盘私密共享的文件',
  `cloud_file_psd` varchar(36) default NULL,
  `upload_file_dir` varchar(128) default NULL COMMENT '通过上传插件上传的文件',
  `apply_detail_html` text COMMENT '作为历史存根使用。当用户签订协议后，用户或者业务员载查看信息时只能查看历史记录，而不是根据数据库信息获取记录',
  `apply_detail_status` varchar(32) default 'undo' COMMENT 'save:历史存根；redo：等待重新处理；undo：未处理',
  PRIMARY KEY  (`id`)
...
-- Records of apply
-- ----------------------------
INSERT INTO `apply` VALUES ('1', 'YXh1czhpNlVaKzA9', '22', '3', '33000', '3', '3300', '3', '无', '2', '工资', '2015-05-21 12:23:30', '3', '1', '21', null, null, null, '<!DOCTYPE html><html><head>    <meta charset=\"UTF-8\">    <title>恒通商务信息咨询有限公司 - 申请信息详情</title>    <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">    <meta http-equiv=\"X-UA-Compatible\" content=\"IE=edge\">    <link rel=\"icon\" type=\"image/png\" href=\"/img/icon.jpg\">    <meta name=\"keywords\" content=\"关键词123\"/>    <meta name=\"description\" content=\"描述信息\"/>    <!-- 新 Bootstrap 核心 CSS 文件 -->    <link href=\"/assets/htsw/detail.css\" rel=\"stylesheet\">    <!--[if lt IE 9]>    <script src=\"/assets/ext/html5shiv.js\"></script>    <script src=\"/assets/ext/respond.min.js\"></script>    <![endif]--></head><body><div class=\"front-content\">    <div><img src=\"/img/logo3.png\" style=\"height: 45px;margin-left: 5px;margin-bottom: 13px\"></div>    <div style=\"font-size: 20px;font-weight: 900;margin: -37px auto 19px;width:960px;text-align: center;\"><b>借款服务申请表</b>    </div>    <div id=\"content-table\">        <div class=\"key\" style=\"width: 161px;\">您申请的产品类型</div>        <div class=\"value\" style=\"width: 466px;\">□ 精英贷 &nbsp; ■ 工薪贷 &nbsp;□ 恒楼贷 &nbsp;□ 商户贷 &nbsp; □ 企业贷 &nbsp; □ 新车贷&nbsp;</div>        <div class=\"key\" style=\"width: 160px;\">您申请的贷款额度</div>        <div class=\"value\" style=\"width: 141px;text-align: center\">33000&nbsp;&nbsp;元</div>        <div id=\"clear\"></div>        <div class=\"key\" style=\"width: 161px;\">您的申请期限</div>        <div class=\"value\" style=\"width: 466px;\">□12个月（精英贷） &nbsp; ■18个月 &nbsp;&nbsp; □24个月&nbsp;&nbsp; □36个月（限精英贷）&nbsp;</div>        <div class=\"key\" style=\"width: 160px;\">您可接受的最高月还款额</div>        <div class=\"value\" style=\"width: 141px;text-align: center\">3300&nbsp;&nbsp;元</div>        <div id=\"clear\"></div>        <div class=\"key\" style=\"width: 162px;padding: 13px 0 14px 3px\">您的借款用途</div>        <div class=\"value\" style=\"width: 783px;padding: 7px 0 6px 6px\">        □ 日常生活消费 &nbsp;&nbsp; ■ 装修 &nbsp;&nbsp;□ 教育支出&nbsp;&nbsp; □ 医疗 &nbsp; □ 支付员工工资 &nbsp; □ 扩大生产/经营<br/>□ 购买货物/原材料/设备 &nbsp;&nbsp;&nbsp;&nbsp; □ 资金周转 &nbsp;&nbsp;□ 购物 &nbsp; □ 其它（请说明） &nbsp;<u>&nbsp;&nbsp;无&nbsp;&nbsp;</u>        </div>        <div id=\"clear\"></div>        <div class=\"key\" style=\"width: 161px;\">还款方式</div>        <div class=\"value\" style=\"width: 466px;\">■ 独立还款 &nbsp;&nbsp;□ 家人协助还款 &nbsp;&nbsp;□ 其它还款方式&nbsp;</div>        <div class=\"key\" style=\"width: 160px;\">还款来源</div>        <div class=\"value\" style=\"width: 141px;text-align: center\">工资&nbsp;</div>        <div id=\"clear\"></div>        <div class=\"value\" style=\"width: 947px;font-weight: 800;padding-bottom: 6px\">您的个人信息</div>        <div id=\"clear\"></div>        <div class=\"key\" style=\"width: 110px;\">姓名</div>        <div class=\"value\" style=\"width: 108px;text-align: center\">用户0001&nbsp;</div>        <div class=\"key\" style=\"width: 60px;\">性别</div>        <div class=\"value\" style=\"width: 106px;\">□ 男 &nbsp;&nbsp;□ 女&nbsp;</div>        <div class=\"key\" style=\"width: 92px;\">联系方式</div>        <div class=\"value\" style=\"width: 174px;\">&nbsp;</div>        <div class=\"key\" style=\"width: 92px;\">手机服务密码</div>        <div class=\"value\" style=\"width: 158px;text-align: center\">&nbsp;</div>        <div id=\"clear\"></div>        <div class=\"key\" style=\"width: 110px;\">婚姻状况</div>        <div class=\"value\" style=\"width: 190px;\">□ 未婚 &nbsp;□ 已婚 &nbsp; □ 离异&nbsp;</div>        <div class=\"key\" style=\"width: 76px;\">身份证号码</div>        <div class=\"value\" style=\"width: 288px;\">&nbsp;</div>        <div class=\"key\" style=\"width: 92px;\">身份证有效期</div>        <div class=\"value\" style=\"width: 158px;text-align: center\">&nbsp;</div>        <div id=\"clear\"></div>        <div class=\"key\" style=\"width: 110px;\">子女数目</div>        <div class=\"value\" style=\"width: 190px;text-align: center\">&nbsp;&nbsp;人</div>        <div class=\"key\" style=\"width: 76px;\">供养人数</div>        <div class=\"value\" style=\"width: 189px;text-align: center\">&nbsp;&nbsp;人</div>        <div class=\"key\" style=\"width: 109px;\">每月家庭支出</div>        <div class=\"value\" style=\"width: 240px;text-align: center\">&nbsp;&nbsp;元</div>        <div id=\"clear\"></div>        <div class=\"key\" style=\"width: 110px;;padding-bottom: 5px\">最高学历</div>        <div class=\"value\" style=\"width: 832px;padding-bottom: 5px\">□ 硕士及以上 &nbsp;&nbsp;&nbsp;□ 本科 &nbsp;&nbsp;&nbsp;□ 大专 &nbsp;&nbsp;&nbsp;□ 中专 &nbsp;&nbsp;&nbsp;□ 高中 &nbsp;&nbsp;&nbsp;□ 初中及以下&nbsp;</div>        <div id=\"clear\"></div>        <div class=\"key\" style=\"width: 110px;\">户籍所在地</div>        <div class=\"value\" style=\"width: 87px;text-align: right;border-right: 0\">-</div>        <div class=\"value\" style=\"width: 10px;border-right: 0;\">省</div>        <div class=\"value\" style=\"width: 80px;text-align: right;border-right: 0\">-</div>        <div class=\"value\" style=\"width: 10px;border-right: 0;border-left:0;\">市</div>        <div class=\"value\"             style=\"width: 82px;text-align: right;border-right: 0;border-left:0 \">-</div>        <div class=\"value\" style=\"width: 10px;border-right: 0;border-left:0;\">区</div>        <div class=\"value\" style=\"width: 505px;border-left:0 ;\">&nbsp;</div>        <div id=\"clear\"></div>        <div class=\"key\" style=\"width: 110px;\">现住宅地址</div>        <div class=\"value\" style=\"width: 87px;text-align: right;border-right: 0\">-</div>        <div class=\"value\" style=\"width: 10px;border-right: 0;\">省</div>        <div class=\"value\" style=\"width: 80px;text-align: right;border-right: 0\">-</div>        <div class=\"value\" style=\"width: 10px;border-right: 0;border-left:0;\">市</div>        <div class=\"value\"             style=\"width: 82px;text-align: right;border-right: 0;border-left:0 \">-</div>        <div class=\"value\" style=\"width: 10px;border-right: 0;border-left:0;\">区</div>        <div class=\"value\" style=\"width: 364px;border-left:0 ;border-right: 0;\">            &nbsp;</div>        <div class=\"value\" style=\"width: 133px;border-left:0 ;\">□ 与户口所在地一致</div>        <div id=\"clear\"></div>        <div class=\"key\" style=\"width: 110px;\">住宅电话</div>        <div class=\"value\" style=\"width: 255px;\">&nbsp;</div>        <div class=\"key\" style=\"width: 110px;\">现住宅居住时间</div>        <div class=\"value\" style=\"width: 156px;\">&nbsp;</div>        <div class=\"key\" style=\"width: 110px;\">来本市的时间</div>        <div class=\"value\" style=\"width: 173px;\">&nbsp;</div>        <div id=\"clear\"></div>        <div class=\"key\" style=\"width: 110px;\">QQ账号</div>        <div class=\"value\" style=\"width: 255px;\">□有<u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u>&nbsp;■无&nbsp;</div>        <div class=\"key\" style=\"width: 110px;\">微信账号</div>        <div class=\"value\" style=\"width: 453px;\">□有<u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u>&nbsp;■无&nbsp;</div>        <div id=\"clear\"></div>        <div class=\"key\" style=\"width: 110px;\">下款卡银行账号</div>        <div class=\"value\" style=\"width: 255px;\">&nbsp;</div>        <div class=\"key\" style=\"width: 110px;\">开户行</div>        <div class=\"value\" style=\"width: 453px;\">&nbsp;</div>        <div id=\"clear\"></div>        <div class=\"key\" style=\"width: 110px;\">信用卡张树</div>        <div class=\"value\" style=\"width: 140px;\">&nbsp;</div>        <div class=\"key\" style=\"width: 110px;\">信用卡最高额度</div>        <div class=\"value\" style=\"width: 156px;\">&nbsp;</div>        <div class=\"key\" style=\"width: 76px;\">其它负债</div>        <div class=\"value\" style=\"width: 121px;\">&nbsp;</div>        <div class=\"key\" style=\"width: 62px;\">月还款</div>        <div class=\"value\" style=\"width: 125px;\">&nbsp;</div>        <div id=\"clear\"></div>        <div class=\"key\" style=\"width: 110px;\">征信登录名</div>        <div class=\"value\" style=\"width: 140px;\">&nbsp;</div>        <div class=\"key\" style=\"width: 110px;\">登陆密码</div>        <div class=\"value\" style=\"width: 156px;\">&nbsp;</div>        <div class=\"key\" style=\"width: 76px;\">查询码</div>        <div class=\"value\" style=\"width: 121px;\">&nbsp;</div>        <div class=\"key\" style=\"width: 62px;\">激活码</div>        <div class=\"value\" style=\"width: 125px;\">&nbsp;</div>        <div id=\"clear\"></div>        <div class=\"key\" style=\"width: 110px;\">电费单户号</div>        <div class=\"value\" style=\"width: 140px;\">&nbsp;</div>        <div class=\"key\" style=\"width: 110px;\">户名</div>        <div class=\"value\" style=\"width: 156px;\">&nbsp;</div>        <div class=\"key\" style=\"width: 76px;\">被执行记录</div>        <div class=\"value\" style=\"width: 322px;\">&nbsp;</div>        <div id=\"clear\"></div>        <div class=\"value\" style=\"width: 947px;font-weight: 800;padding-bottom: 6px\">您的房产及车辆信息</div>        <div id=\"clear\"></div>        <div class=\"key\" style=\"width: 111px;padding: 9px 0 10px 3px\">房产类型</div>        <div class=\"value\" style=\"width: 833px;padding: 3px 0 3px 7px\">        □商业按揭购房&nbsp; □公积金按揭购房&nbsp; □商业/公积金按揭购房&nbsp;&nbsp;&nbsp; □无按揭购房 &nbsp;□自建房<br/>□与父母同住&nbsp;&nbsp;&nbsp; □亲属住房&nbsp;&nbsp;&nbsp; □ 临时居住 &nbsp;&nbsp;&nbsp;&nbsp; □租房&nbsp;（ 租金<u>&nbsp;&nbsp;&nbsp;&nbsp;</u>元/月 ）        </div>        <div id=\"clear\"></div>        <div class=\"key\" style=\"width: 110px;\">房产购买时间</div>        <div class=\"value\" style=\"width: 173px;\">&nbsp;</div>        <div class=\"key\" style=\"width: 110px;\">购买价格</div>        <div class=\"value\" style=\"width: 138px;\">&nbsp;&nbsp;万元</div>        <div class=\"key\" style=\"width: 110px;\">建筑面积</div>        <div class=\"value\" style=\"width: 74px;\"><u>&nbsp;&nbsp;</u>平方米</div>        <div class=\"key\" style=\"width: 92px;\">产权比例</div>        <div class=\"value\" style=\"width: 93px;\"><u>&nbsp;&nbsp;&nbsp;&nbsp;</u>%</div>        <div id=\"clear\"></div>        <div class=\"key\" style=\"width: 110px;\">房产地址</div>        <div class=\"value\" style=\"width: 87px;text-align: right;border-right: 0\">-</div>        <div class=\"value\" style=\"width: 10px;border-right: 0;\">省</div>        <div class=\"value\" style=\"width: 80px;text-align: right;border-right: 0\">-</div>        <div class=\"value\" style=\"width: 10px;border-right: 0;border-left:0;\">市</div>        <div class=\"value\"             style=\"width: 82px;text-align: right;border-right: 0;border-left:0 \">-</div>        <div class=\"value\" style=\"width: 10px;border-right: 0;border-left:0;\">区</div>        <div class=\"value\" style=\"width: 364px;border-left:0 ;border-right: 0;\">            &nbsp;</div>        <div class=\"value\" style=\"width: 133px;border-left:0 ;\">□ 与现住宅地址一致</div>        <div id=\"clear\"></div>        <div class=\"key\" style=\"width: 110px;\">贷款年限</div>        <div class=\"value\" style=\"width: 173px;\">&nbsp;&nbsp;年</div>        <div class=\"key\" style=\"width: 110px;\">月供</div>        <div class=\"value\" style=\"width: 138px;\">&nbsp;&nbsp;元</div>        <div class=\"key\" style=\"width: 110px;\">贷款余额</div>        <div class=\"value\" style=\"width: 273px;\">&nbsp;&nbsp;&nbsp;万</div>        <div id=\"clear\"></div>        <div class=\"key\" style=\"width: 110px;\">车辆情况</div>        <div class=\"value\" style=\"width: 633px;\">■无&nbsp;□有（全款购买，金额<u>&nbsp;&nbsp;</u>万元）&nbsp;□有（按揭购买，月供<u>&nbsp;&nbsp;</u>万元）&nbsp;</div>        <div class=\"key\" style=\"width: 92px;\">购买时间</div>        <div class=\"value\" style=\"width: 93px;\">&nbsp;</div>        <div id=\"clear\"></div>        <div class=\"value\" style=\"width: 947px;font-weight: 800;padding-bottom: 6px\">您的工作信息</div>        <div id=\"clear\"></div>        <div class=\"key\" style=\"width: 110px;\">工作单位名称</div>        <div class=\"value\" style=\"width: 222px;\">&nbsp;</div>        <div class=\"key\" style=\"width: 75px;\">单位性质</div>        <div class=\"value\" style=\"width: 521px;\">□政府机关&nbsp;□事业单位&nbsp;□国企&nbsp;&nbsp;□外企&nbsp;&nbsp;□合资&nbsp;&nbsp;□民营&nbsp;&nbsp;□私企&nbsp;&nbsp;□个体&nbsp;</div>        <div id=\"clear\"></div>        <div class=\"key\" style=\"width: 111px;padding: 16px 0 18px 3px\">职位级别</div>        <div class=\"value\" id=\"job_type\" style=\"width: 834px;padding: 3px 0 3px 6px\">        公务员类&nbsp;&nbsp;□厅级及以上&nbsp;&nbsp;□局级&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;□处级&nbsp;&nbsp;&nbsp;&nbsp;□科级&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;□一般干部&nbsp;<br/>非公务员类&nbsp;□法人&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;□股东&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;□企业负责人&nbsp;□高层管理人员&nbsp;□中层管理人员<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;□一般管理人员&nbsp;□一般正式员工&nbsp;□派遣员工&nbsp;&nbsp;□其它（请说明）<u>&nbsp;&nbsp;</u>        </div>        <div id=\"clear\"></div>        <div class=\"key\" style=\"width: 111px;padding: 11px 0 13px 3px\">所属行业</div>        <div class=\"value\" style=\"width: 834px;padding: 6px 0 4px 6px\">        □政府机关&nbsp;□军事机关&nbsp;□教育、科研、设计机构&nbsp;□传媒、文化体育&nbsp;□高新技术制造业&nbsp;□建筑业&nbsp;□传统制造业<br/>□金融业&nbsp;&nbsp;□服务业&nbsp;&nbsp;□零售、商贸、企业&nbsp;&nbsp;&nbsp;□专业服务机构&nbsp;&nbsp;□公共事业&nbsp;&nbsp;&nbsp;&nbsp;□医院        </div>        <div id=\"clear\"></div>        <div class=\"key\" style=\"width: 110px;\">部门</div>        <div class=\"value\" style=\"width: 205px;\">&nbsp;</div>        <div class=\"key\" style=\"width: 110px;\">职务名称</div>        <div class=\"value\" style=\"width: 90px;\">&nbsp;</div>        <div class=\"key\" style=\"width: 110px;\">前单位名称</div>        <div class=\"value\" style=\"width: 289px;\">&nbsp;</div>        <div id=\"clear\"></div>        <div class=\"key\" style=\"width: 110px;\">现单位入职时间</div>        <div class=\"value\" style=\"width: 205px;\">&nbsp;</div>        <div class=\"key\" style=\"width: 110px;\">单位电话</div>        <div class=\"value\" style=\"width: 503px;\"><u>&nbsp;####&nbsp;</u>（区号）<u>&nbsp;########&nbsp;</u>（总机）<u>&nbsp;####&nbsp;</u>（分机）&nbsp;</div>        <div id=\"clear\"></div>        <div class=\"key\" style=\"width: 110px;\">现单位地址</div>        <div class=\"value\" style=\"width: 87px;text-align: right;border-right: 0\">-            &nbsp;</div>        <div class=\"value\" style=\"width: 10px;border-right: 0;\">省</div>        <div class=\"value\" style=\"width: 80px;text-align: right;border-right: 0\">-            </div>        <div class=\"value\" style=\"width: 10px;border-right: 0;border-left:0;\">市</div>        <div class=\"value\"             style=\"width: 82px;text-align: center;border-right: 0;border-left:0 \">-            &nbsp;</div>        <div class=\"value\" style=\"width: 10px;border-right: 0;border-left:0;\">区</div>        <div class=\"value\" style=\"width: 505px;border-left:0 ;\">&nbsp;</div>        <div id=\"clear\"></div>        <div class=\"key\" style=\"width: 110px;\">工资发放形式</div>        <div class=\"value\" style=\"width: 205px;\">&nbsp;</div>        <div class=\"key\" style=\"width: 110px;\">每月基本薪金</div>        <div class=\"value\" style=\"width: 90px;\">&nbsp;元</div>        <div class=\"key\" style=\"width: 110px;\">其它收入（月均）</div>        <div class=\"value\" style=\"width: 88px;\">&nbsp;元</div>        <div class=\"key\" style=\"width: 93px;\">每月发薪日</div>        <div class=\"value\" style=\"width: 94px;\">&nbsp;日</div>        <div id=\"clear\"></div>        <div class=\"key\" style=\"width: 110px;\">公积金缴纳金额</div>        <div class=\"value\" style=\"width: 419px;\">公司缴纳<u>&nbsp;&nbsp;&nbsp;&nbsp;</u>元&nbsp;&nbsp;个人缴纳<u>            &nbsp;&nbsp;&nbsp;&nbsp;</u>元        </div>        <div class=\"key\" style=\"width: 110px;\">社会保障卡号</div>        <div class=\"value\" style=\"width: 289px;\">&nbsp;</div>        <div id=\"clear\"></div>        <div class=\"value\" style=\"width: 947px;font-weight: 800;padding-bottom: 6px\">*如果您是私营企业主，请补充填写以下内容</div>        <div id=\"clear\"></div>        <div class=\"key\" style=\"width: 110px;;padding-bottom: 4px\">企业类型</div>        <div class=\"value\" style=\"width: 832px;padding-bottom: 4px\">□私营股份有限公司&nbsp;□私营有限责任公司&nbsp;□私营合作&nbsp;&nbsp;□私营独资&nbsp;&nbsp;□个体&nbsp;&nbsp;□其它（请说明）<u>            &nbsp;&nbsp;</u></div>        <div id=\"clear\"></div>        <div class=\"key\" style=\"width: 110px;\">企业成立时间</div>        <div class=\"value\" style=\"width: 155px;\">&nbsp;</div>        <div class=\"key\" style=\"width: 77px;\">股份占比</div>        <div class=\"value\" style=\"width: 75px;\">&nbsp;%</div>        <div class=\"key\" style=\"width: 76px;\">员工人数</div>        <div class=\"value\" style=\"width: 105px;\">&nbsp;人</div>        <div class=\"key\" style=\"width: 76px;\">经营场所</div>        <div class=\"value\" style=\"width: 226px;\">□自有房产&nbsp;□租用</div>        <div id=\"clear\"></div>        <div class=\"key\" style=\"width: 110px;\">企业每月净利润</div>        <div class=\"value\" style=\"width: 155px;\">&nbsp;</div>        <div class=\"key\" style=\"width: 77px;\">经营场所</div>        <div class=\"value\" style=\"width: 270px;\">□自有房产&nbsp;□租用（月租金<u>            &nbsp;&nbsp;</u>元）        </div>        <div class=\"key\" style=\"width: 79px;padding-left: 1px\">租赁到期日期</div>        <div class=\"value\" style=\"width: 226px;\">&nbsp;</div>        <div id=\"clear\"></div>        <div class=\"value\" style=\"width: 947px;font-weight: 800;padding-bottom: 5px\">联系人信息</div>        <div id=\"clear\"></div>        <div class=\"key\" style=\"width: 108px;padding: 13px 0 13px 6px\">配偶</div>        <div class=\"value\" style=\"width: 841px;padding:0;border: 0;\">            <div class=\"value\" style=\"width: 57px;text-align: center\">姓名</div>            <div class=\"value\" style=\"width: 90px;text-align: center\">&nbsp;</div>            <div class=\"key\" style=\"width: 92px;\">移动电话</div>            <div class=\"value\" style=\"width: 172px;\">&nbsp;</div>            <div class=\"key\" style=\"width: 93px;\">单位名称</div>            <div class=\"value\" style=\"width: 291px;\">&nbsp;</div>            <div id=\"clear\"></div>            <div class=\"value\" style=\"width: 57px;text-align: center\">单位电话</div>            <div class=\"value\" style=\"width: 368px;\"><u>&nbsp;####&nbsp;</u>（区号）<u>&nbsp;########&nbsp;</u>（总机）<u>&nbsp;####&nbsp;</u>（分机）&nbsp;</div>            <div class=\"key\" style=\"width: 93px;\">单位地址</div>            <div class=\"value\" style=\"width: 291px;\">&nbsp;</div>            <div id=\"clear\"></div>        </div>        <div id=\"clear\"></div>        <div class=\"key\" style=\"width: 108px;padding: 13px 0 13px 6px\">直系亲属</div>        <div class=\"value\" style=\"width: 841px;padding:0;border: 0;\">            <div class=\"value\" style=\"width: 57px;text-align: center\">姓名</div>            <div class=\"value\" style=\"width: 90px;text-align: center\">&nbsp;</div>            <div class=\"key\" style=\"width: 92px;\">移动电话</div>            <div class=\"value\" style=\"width: 172px;\">&nbsp;</div>            <div class=\"key\" style=\"width: 93px;\">亲属关系</div>            <div class=\"value\" style=\"width: 291px;\">&nbsp;</div>            <div id=\"clear\"></div>            <div class=\"value\" style=\"width: 57px;text-align: center\">住宅电话</div>            <div class=\"value\" style=\"width: 368px;\"><u>&nbsp;####&nbsp;</u>（区号）<u>&nbsp;########&nbsp;</u>（总机）<u>&nbsp;####&nbsp;</u>（分机）&nbsp;</div>            <div class=\"key\" style=\"width: 93px;\">住宅地址</div>            <div class=\"value\" style=\"width: 291px;\">&nbsp;</div>            <div id=\"clear\"></div>        </div>        <div id=\"clear\"></div>        <div class=\"key\" style=\"width: 108px;padding: 13px 0 13px 6px\">同事</div>        <div class=\"value\" style=\"width: 841px;padding:0;border: 0;\">            <div class=\"value\" style=\"width: 57px;text-align: center\">姓名</div>            <div class=\"value\" style=\"width: 90px;text-align: center\">&nbsp;</div>            <div class=\"key\" style=\"width: 92px;\">移动电话</div>            <div class=\"value\" style=\"width: 172px;\">&nbsp;</div>            <div class=\"value\" style=\"width: 389px;text-align: center\">&nbsp;</div>            <div id=\"clear\"></div>            <div class=\"value\" style=\"width: 57px;text-align: center\">单位电话</div>            <div class=\"value\" style=\"width: 368px;\"><u>&nbsp;####&nbsp;</u>（区号）<u>&nbsp;########&nbsp;</u>（总机）<u>&nbsp;####&nbsp;</u>（分机）&nbsp;</div>            <div class=\"key\" style=\"width: 93px;\">部门</div>            <div class=\"value\" style=\"width: 90px;\">&nbsp;</div>            <div class=\"key\" style=\"width: 93px;\">职务</div>            <div class=\"value\" style=\"width: 94px;\">&nbsp;</div>            <div id=\"clear\"></div>        </div>        <div id=\"clear\"></div>        <div class=\"key\" style=\"width: 108px;padding: 13px 0 13px 6px\">其他联系人</div>        <div class=\"value\" style=\"width: 841px;padding:0;border: 0;\">            <div class=\"value\" style=\"width: 57px;text-align: center\">姓名</div>            <div class=\"value\" style=\"width: 90px;text-align: center\">&nbsp;</div>            <div class=\"key\" style=\"width: 92px;\">移动电话</div>            <div class=\"value\" style=\"width: 172px;\">&nbsp;</div>            <div class=\"key\" style=\"width: 93px;\">关系</div>            <div class=\"value\" style=\"width: 291px;\">&nbsp;</div>            <div id=\"clear\"></div>            <div class=\"value\" style=\"width: 57px;text-align: center\">住宅电话</div>            <div class=\"value\" style=\"width: 766px;\"><u>&nbsp;####&nbsp;</u>（区号）<u>&nbsp;########&nbsp;</u>（总机）<u>&nbsp;####&nbsp;</u>（分机）&nbsp;</div>            <div id=\"clear\"></div>        </div>        <div id=\"clear\"></div>        <div class=\"key\" style=\"width: 176px;\">以上联系人是否知晓此项借款</div>        <div class=\"value\" style=\"width: 73px;text-align: center\">配偶:</div>        <div class=\"value\" style=\"width: 89px;\">□是 &nbsp;&nbsp;□否</div>        <div class=\"value\" style=\"width: 90px;text-align: center\">直系亲属:</div>        <div class=\"value\" style=\"width: 89px;\">□是 &nbsp;&nbsp;□否</div>        <div class=\"value\" style=\"width: 90px;text-align: center\">同事:</div>        <div class=\"value\" style=\"width: 89px;\">□是 &nbsp;&nbsp;□否</div>        <div class=\"value\" style=\"width: 90px;text-align: center\">其他联系人:</div>        <div class=\"value\" style=\"width: 93px;\">□是 &nbsp;&nbsp;□否</div>        <div id=\"clear\"></div>        <div class=\"key\" style=\"width: 955px;padding: 0\">            <div style=\"width: 950px;text-align: center;font-weight: bold;margin-top: 5px\">特别声明</div>            <div style=\"font-weight: normal;padding-top: 8px;line-height:133%;padding-bottom: 6px\">                &nbsp;本借款申请人承诺：1、本申请表填写内容真实，如有不实，本人愿意承担相应法律责任。2、借款资金不会以任何形式进入证券市场，或用于股本权益性投资；不用于国家明令禁止或限制的经营活动；不用于房产地项目开发。                本人授权恒通信用管理有限公司（以下简称“贵公司”）在任何依法成立的征信机构及银行了解和查询本人财产、个人信用记录等信息，并同意贵公司：                1、收集本人的有关资料作为本次借款申请之用；                2、有权处理本人所有相关个人信息及资料（包括但不限于将本人的个人信息、个人信贷交易记录以及其它相关信息报送相关依法成立的征信机构）；                3、贵公司有权同意或拒绝本人的借款申请且无须提供任何理由及无须退回所有申请资料副本给本人。            </div>        </div>        <div id=\"clear\"></div>        <div class=\"value\" style=\"width: 156px;padding: 14px 0 15px 6px\">借款人签字：</div>        <div class=\"value\" style=\"width: 322px;text-align: center;padding: 14px 0 15px 6px\">&nbsp;</div>        <div class=\"value\" style=\"width: 156px;padding: 14px 0 15px 6px\">申请日期：</div>        <div class=\"value\" style=\"width: 294px;text-align: center;padding: 14px 0 15px 6px\">&nbsp;</div>        <div id=\"clear\"></div>        <div class=\"key\" style=\"width: 951px;font-weight: 800;padding-bottom: 5px;text-align: center\">工作人员填写</div>        <div id=\"clear\"></div>        <div class=\"key\" style=\"width: 80px;padding: 5px 0 5px 4px;\">客户来源</div>        <div class=\"value\" style=\"width: 560px;padding: 5px 0 5px 4px;\">&nbsp;</div>        <div class=\"key\" style=\"width: 65px;padding: 5px 0 5px 4px;\">团队经理：</div>        <div class=\"value\" style=\"width: 68px;padding: 5px 0 5px 4px;\">&nbsp;</div>        <div class=\"key\" style=\"width: 65px;padding: 5px 0 5px 4px;\">客户经理：</div>        <div class=\"value\" style=\"width: 88px;padding: 5px 0 5px 4px;\">&nbsp;</div>        <div id=\"clear\"></div>    </div></div></body></html>', 'save');
INSERT INTO `apply` VALUES ('2', 'MU5ia215RmJTQjA9', '23', '2', '23000', '3', '2344', '4', null, '2', '工资', '2015-06-20 13:40:44', '2', '1', '9', null, null, null, null, 'undo');
INSERT INTO `apply` VALUES ('3', 'dGNDb2xUMTJZKzg9', '25', '4', '234566', '4', '2323', '5', '算法色', '3', '生日蛋糕', '2015-06-20 13:41:33', '2', '1', '9', null, null, null, null, 'undo');
INSERT INTO `apply` VALUES ('4', 'OGRkZU5RTjdKZUk9', '26', '4', '3456232', '3', '23455', '11', '岁的法国', '3', '文人同', '2015-06-20 13:42:02', '2', '1', '9', null, null, null, null, 'undo');
...
INSERT INTO `apply_log` VALUES ('7', '1', '21', '2015-06-23 20:16:39', '资料审核通过资料审核通过资料审核通过');
INSERT INTO `apply_log` VALUES ('8', '1', '21', '2015-06-23 20:16:51', '资料审核通过退出操作资料审核通过退出操作');
INSERT INTO `apply_log` VALUES ('9', '1', '21', '2015-06-23 20:34:03', 'applyDeal/YXh1czhpNlVaKzA9');
INSERT INTO `apply_log` VALUES ('10', '1', '21', '2015-06-23 20:37:03', '8010/employee/applyDeal/YXh1czhpNlVaKzA9');
INSERT INTO `apply_log` VALUES ('11', '1', '21', '2015-06-23 20:37:14', '8010/employee/applyDeal/YXh1czhpNlVaKzA9');
INSERT INTO `apply_log` VALUES ('12', '1', '21', '2015-06-23 20:38:29', '10/employee/applyDeal/YXh1czhpNlVaKzA9');
INSERT INTO `apply_log` VALUES ('13', '1', '21', '2015-06-23 20:38:51', '10/employee/applyDeal/YXh1czhpNlVaKzA9');
INSERT INTO `apply_log` VALUES ('14', '1', '21', '2015-06-23 20:41:21', '装修   □ 教育支出   □ 医疗   □ 支付员工工资   □ 扩大生产/经营\n□ 购买货物/原材料/设备      □ 资金周转   □ 购物   □ 其它（请说明）    无');
INSERT INTO `apply_log` VALUES ('15', '1', '21', '2015-06-23 20:41:44', '□ 已婚   □ 离异 身份证号码 ');
INSERT INTO `apply_log` VALUES ('16', '1', '21', '2015-06-23 20:43:13', '   □ 离异 身份证号码 身份证有效期 \n子女数目  人供养人数  人每月家庭支出  元\n最高学历□ 硕士及以上    □ 本科    □ 大专    □ 中专    □ 高中    □ 初中及以下 \n户籍所在地-省-市-区 \n现住宅地址-省-市-区  □ 与户口所在地一致\n住宅电话 现住');
INSERT INTO `apply_log` VALUES ('17', '1', '21', '2015-06-23 20:43:54', '厅级及以上  □局级     □处级    □');
INSERT INTO `apply_log` VALUES ('18', '1', '21', '2015-06-23 20:45:04', '□ 购物   □ 其它');
INSERT INTO `apply_log` VALUES ('19', '1', '21', '2015-06-23 20:45:32', '用户0001 ');
...
-- ----------------------------
INSERT INTO `apply_product_type` VALUES ('1', '-', '□ 精英贷 &nbsp; □ 工薪贷 &nbsp;□ 恒楼贷 &nbsp;□ 商户贷 &nbsp; □ 企业贷 &nbsp; □ 新车贷');
INSERT INTO `apply_product_type` VALUES ('2', '精英贷', '■ 精英贷 &nbsp; □ 工薪贷 &nbsp;□ 恒楼贷 &nbsp;□ 商户贷 &nbsp; □ 企业贷 &nbsp; □ 新车贷');
INSERT INTO `apply_product_type` VALUES ('3', '工薪贷', '□ 精英贷 &nbsp; ■ 工薪贷 &nbsp;□ 恒楼贷 &nbsp;□ 商户贷 &nbsp; □ 企业贷 &nbsp; □ 新车贷');
INSERT INTO `apply_product_type` VALUES ('4', '恒楼贷', '□ 精英贷 &nbsp; □ 工薪贷 &nbsp;■ 恒楼贷 &nbsp;□ 商户贷 &nbsp; □ 企业贷 &nbsp; □ 新车贷');
INSERT INTO `apply_product_type` VALUES ('5', '商户贷', '□ 精英贷 &nbsp; □ 工薪贷 &nbsp;□ 恒楼贷 &nbsp;■ 商户贷 &nbsp; □ 企业贷 &nbsp; □ 新车贷');
INSERT INTO `apply_product_type` VALUES ('6', '企业贷', '□ 精英贷 &nbsp; □ 工薪贷 &nbsp;□ 恒楼贷 &nbsp;□ 商户贷 &nbsp; ■ 企业贷 &nbsp; □ 新车贷');
INSERT INTO `apply_product_type` VALUES ('7', '新车贷', '□ 精英贷 &nbsp; □ 工薪贷 &nbsp;□ 恒楼贷 &nbsp;□ 商户贷 &nbsp; □ 企业贷 &nbsp; ■ 新车贷');
...
-- ----------------------------
INSERT INTO `c_webconfig` VALUES ('1', 'webName', '恒通商务信息咨询有限公司', '网站名称', '2014-12-02 09:55:13', '2015-06-22 14:59:12', '1');
INSERT INTO `c_webconfig` VALUES ('2', 'webCopyright', '版权所有&copy; 2015 www.htsw.org', '网站底部copyright', '2014-12-02 09:55:13', '2015-06-22 14:59:14', '1');
INSERT INTO `c_webconfig` VALUES ('3', 'ICP', '苏ICP备14019371号-2', '网站ICP', '2014-12-02 09:55:13', '2015-06-22 14:59:16', '1');
...
INSERT INTO `c_webconfig` VALUES ('6', 'description', '描述信息', '描述信息', '2014-12-02 09:55:13', '2015-06-22 14:59:17', '1');
INSERT INTO `c_webconfig` VALUES ('7', 'hotline', '0518-88888888', '客服热线', '2014-12-02 09:55:13', '2015-06-22 14:59:19', '1');
INSERT INTO `c_webconfig` VALUES ('8', 'email', 'help@htsw.org', '客服邮箱', '2014-12-02 09:55:13', '2015-06-22 14:59:23', '1');
INSERT INTO `c_webconfig` VALUES ('9', 'companyname', '恒通商务信息咨询有限公司', '公司名称', '2014-12-02 09:55:13', '2015-06-22 14:59:20', '1');
INSERT INTO `c_webconfig` VALUES ('10', 'weburl', 'http://localhost:8010/', '公司网址', '2014-12-02 09:55:13', '2015-06-22 14:59:24', '1');
INSERT INTO `c_webconfig` VALUES ('101', 'email_from', 'htsw_no_reply@163.com', '发邮件地址', '2014-12-02 09:55:13', '2015-06-23 12:44:50', '1');
INSERT INTO `c_webconfig` VALUES ('102', 'email_host', 'smtp.163.com', '邮件服务器', '2014-12-02 09:55:13', '2015-06-23 12:45:15', '1');
INSERT INTO `c_webconfig` VALUES ('103', 'email_user', 'htsw_no_reply', '邮件的用户名', '2014-12-02 09:55:13', '2015-06-23 12:45:27', '1');
INSERT INTO `c_webconfig` VALUES ('104', 'email_upsd', 'HtswNoReply2015', '邮件的密码', '2014-12-02 09:55:13', '2015-06-23 12:45:39', '1');
INSERT INTO `c_webconfig` VALUES ('105', 'email_reg_title', '恒通商务 用户注册验', '用户注册认证邮件标题', '2014-12-02 09:55:13', '2015-06-22 14:59:00', '1');
INSERT INTO `c_webconfig` VALUES ('106', 'email_reg_text', '尊敬的用户您好，您的注册邮箱验证码是：', '用户注册认证邮件正文', '2014-12-02 09:55:13', '2015-06-22 14:59:01', '1');
INSERT INTO `c_webconfig` VALUES ('107', 'mail_find_psd_title', '恒通商务 找回密码', '用户找回密码邮件标题', '2014-12-02 09:55:13', '2015-06-22 14:58:50', '1');
INSERT INTO `c_webconfig` VALUES ('108', 'mail_find_psd_text', '尊敬的用户您好，您正在找回密码，您的找回密码的验证码是：', '用户找回密码邮件正文', '2014-12-02 09:55:13', '2015-06-22 14:58:48', '1');
...
CREATE TABLE `user` (
  ...
  `forget_valid` varchar(256) default NULL,
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', '无', '21232f297a57a5aab269fa0e4a801fc3', '客户', '客户', '0', null, null, null, null, '1', '1', null, null, '2015-05-16 12:57:37', '', null, null, null, '0', '1', null, null);
INSERT INTO `user` VALUES ('2', 'hengtong8', 'cfceb6027a2cf04ab269fc4e4dda53d8', '恒通商务', '恒通商务', '0', null, null, null, 'hengtong8@htsw.org', '1', '1', null, null, '2015-06-23 12:44:26', '127.0.0.1', null, null, null, '0', '1', null, null);
INSERT INTO `user` VALUES ('9', '无处理人员', 'asdfasfqwefSDfawdfhtf tsdfg', '无处理人员', '无处理人员', '0', null, null, null, '无处理人员', '0', '0', '2015-05-21 12:13:18', null, '2015-05-21 12:13:18', '127.0.0.1', null, null, null, '0', '1', null, null);
INSERT INTO `user` VALUES ('21', 'employee', 'cb081f2d4b733821a865f5d306a7c8f2', null, '业务员', '0', null, null, null, 'employee@htsw.org', '0', '0', '2015-05-21 12:13:18', null, '2015-06-23 20:06:10', '127.0.0.1', null, null, null, '0', '1', null, null);
INSERT INTO `user` VALUES ('22', 'member1', 'c07a9d9db49ed8cb44c835f7104ddab6', null, '用户0001', '0', null, null, null, 'member1@qq.com', '0', '0', '2015-05-21 12:18:44', null, '2015-06-23 20:46:18', '127.0.0.1', null, null, null, '0', '1', 'checked', null);
INSERT INTO `user` VALUES ('23', 'member2', '30eaeba7dd9028fde058874ada890121', null, '用户2', '0', null, null, null, 'member2@qq.com', '0', '0', '2015-05-21 12:22:00', null, '2015-06-20 13:40:20', null, null, null, null, '0', '1', 'checked', null);
INSERT INTO `user` VALUES ('24', 'snowfigure1', '6c6d18ba639f0f70c98b9ef30c44418a', null, null, '0', null, null, null, 'fengduqing@126.com', '0', '0', '2015-05-24 10:37:31', null, '2015-06-22 15:14:11', null, null, null, null, '0', '1', 'checked', '');
INSERT INTO `user` VALUES ('25', 'member3', 'e6b46d9625c11962b29a423aecf98dcd', null, null, '0', null, null, null, 'member3@126.com', '0', '0', '2015-06-20 13:38:19', null, '2015-06-22 15:18:18', null, null, null, null, '0', '1', 'checked', null);
INSERT INTO `user` VALUES ('26', 'member4', '968dd92d435d4c859321b06d28357ce1', null, null, '0', null, null, null, 'member4@126.com', '0', '0', '2015-06-20 13:38:35', null, '2015-06-20 13:41:42', null, null, null, null, '0', '1', 'checked', null);
INSERT INTO `user` VALUES ('27', 'member5', 'ac4c49a2d9cb9979bb4cdb5c8522ca07', null, null, '0', null, null, null, 'member5@126.com', '0', '0', '2015-06-20 13:38:47', null, null, null, null, null, null, '0', '1', 'checked', null);
INSERT INTO `user` VALUES ('28', 'member6', 'e37b17480b1005520aac42fb967c93d5', null, null, '0', null, null, null, 'member6@126.com', '0', '0', '2015-06-20 13:39:02', null, null, null, null, null, null, '0', '1', '', null);
INSERT INTO `user` VALUES ('29', 'teardream', 'b55facb939e16e109adbd10bc60c1edf', null, null, '0', null, null, null, '470697056@qq.com', '0', '0', '2015-06-23 12:46:07', null, '2015-06-23 13:03:16', '127.0.0.1', null, null, null, '0', '1', '1435034767023', null);
...
INSERT INTO `user_bank` VALUES ('23', '29', null, null, null, null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `user_bank` VALUES ('24', '29', null, null, null, null, null, null, null, null, null, null, null, null, null, null);
...
INSERT INTO `user_car` VALUES ('23', '29', null, '1', null, '0');
INSERT INTO `user_car` VALUES ('24', '29', null, '1', null, '0');
...
INSERT INTO `user_company` VALUES ('23', '29', null, null, '1', '1', null, '1', null, null, null, null, '####-########-####', '1', '1', '1', null, '1', null, null, null, null, null, null);
INSERT INTO `user_company` VALUES ('24', '29', null, null, '1', '1', null, '1', null, null, null, null, '####-########-####', '1', '1', '1', null, '1', null, null, null, null, null, null);
...
INSERT INTO `user_contact` VALUES ('23', '29', null, null, null, null, '####-########-####', null, null, null, null, null, '####-########-####', null, null, null, null, '####-########-####', null, null, null, null, null, null, '####-########-####', null);
INSERT INTO `user_contact` VALUES ('24', '29', null, null, null, null, '####-########-####', null, null, null, null, null, '####-########-####', null, null, null, null, '####-########-####', null, null, null, null, null, null, '####-########-####', null);
...
-- ----------------------------
INSERT INTO `user_enable_type` VALUES ('1', '可用', null);
INSERT INTO `user_enable_type` VALUES ('2', '已禁用', null);
...
INSERT INTO `user_enterprise` VALUES ('23', '29', null, '1', null, null, null, null, '1', null, null, null);
INSERT INTO `user_enterprise` VALUES ('24', '29', null, '1', null, null, null, null, '1', null, null, null);
...
INSERT INTO `user_house` VALUES ('23', '29', null, '1', null, null, null, null, null, '1', '1', '1', null, null, null, null);
INSERT INTO `user_house` VALUES ('24', '29', null, '1', null, null, null, null, null, '1', '1', '1', null, null, null, null);
...
-- ----------------------------
INSERT INTO `user_info` VALUES ('16', '22', null, '用户0001', '1', null, null, '1', null, null, null, null, null, '1', '1', '1', '1', null, '1', '1', '1', null, null, null, null, null, null);
INSERT INTO `user_info` VALUES ('17', '23', null, '用户2', '1', null, null, '1', null, null, null, null, null, '1', '1', '1', '1', null, '1', '1', '1', null, null, null, null, null, null);
...
INSERT INTO `user_info` VALUES ('23', '29', null, null, '1', null, null, '1', null, null, null, null, null, '1', '1', '1', '1', null, '1', '1', '1', null, null, null, null, null, null);
INSERT INTO `user_info` VALUES ('24', '29', null, null, '1', null, null, '1', null, null, null, null, null, '1', '1', '1', '1', null, '1', '1', '1', null, null, null, null, null, null);
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_userinfo_admin` AS select `user`.`id` AS `id`,`user`.`username` AS `username`,`user`.`nickname` AS `nickname`,`u_role`.`name` AS `role_name`,`user`.`email` AS `email`,`user`.`create_time` AS `create_time`,`user`.`update_time` AS `update_time`,`user`.`last_login_time` AS `last_login_time`,`user`.`enable` AS `enable`,`user`.`delete_status` AS `delete_status`,`user`.`name` AS `realname`,`user_enable_type`.`name` AS `enable_text`,`user`.`last_login_ip` AS `last_login_ip` from (((`u_role_user` join `u_role`) join `user_enable_type`) join `user`) where ((`u_role`.`id` = 2) and (`u_role_user`.`role_id` = `u_role`.`id`) and (`u_role_user`.`user_id` = `user`.`id`) and (`user_enable_type`.`id` = `user`.`enable`)) ;

-- ----------------------------
-- View structure for `v_userinfo_employee`
-- ----------------------------
DROP VIEW IF EXISTS `v_userinfo_employee`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_userinfo_employee` AS select `user`.`id` AS `id`,`user`.`username` AS `username`,`user`.`nickname` AS `nickname`,`u_role`.`name` AS `role_name`,`user`.`email` AS `email`,`user`.`create_time` AS `create_time`,`user`.`update_time` AS `update_time`,`user`.`last_login_time` AS `last_login_time`,`user`.`enable` AS `enable`,`user`.`delete_status` AS `delete_status`,`user`.`name` AS `realname`,`user_enable_type`.`name` AS `enable_text`,`user`.`last_login_ip` AS `last_login_ip` from (((`u_role_user` join `u_role`) join `user_enable_type`) join `user`) where ((`u_role`.`id` = 3) and (`u_role_user`.`role_id` = `u_role`.`id`) and (`u_role_user`.`user_id` = `user`.`id`) and (`user_enable_type`.`id` = `user`.`enable`)) ;

-- ----------------------------
-- View structure for `v_userinfo_member`
-- ----------------------------
DROP VIEW IF EXISTS `v_userinfo_member`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_userinfo_member` AS select `user`.`id` AS `id`,`user`.`username` AS `username`,`user`.`nickname` AS `nickname`,`u_role`.`name` AS `role_name`,`user`.`email` AS `email`,`user`.`create_time` AS `create_time`,`user`.`update_time` AS `update_time`,`user`.`last_login_time` AS `last_login_time`,`user`.`enable` AS `enable`,`user`.`delete_status` AS `delete_status`,`user`.`name` AS `realname`,`user_enable_type`.`name` AS `enable_text`,`user`.`reg_valid` AS `reg_valid`,`user`.`last_login_ip` AS `last_login_ip` from (((`u_role_user` join `u_role`) join `user_enable_type`) join `user`) where ((`u_role`.`id` = 4) and (`u_role_user`.`role_id` = `u_role`.`id`) and (`u_role_user`.`user_id` = `user`.`id`) and (`user_enable_type`.`id` = `user`.`enable`)) ;
